    ...
    return (
        <footer className="footer containerFooter">
            ...
            <div className="footer__links-container">
                <div className="footer__links-container__links">
                    <p>Features</p>
                    <a aria-label="Go to Link Shortening" href="#">Link Shortening</a>
                    <a aria-label="Go to Branded Links" href="#">Branded Links</a>
                    <a aria-label="Go to Analytics" href="#">Analytics</a>
                </div>
                <div className="footer__links-container__links">
                    <p>Resources</p>
                    <a aria-label="Go to Blog" href="#">Blog</a>
                    <a aria-label="Go to Developers" href="#">Developers</a>
                    <a aria-label="Go to Support" href="#">Support</a>
                </div>
                <div className="footer__links-container__links">
                    <p>Company</p>
                    <a aria-label="Go to About" href="#">About</a>
                    <a aria-label="Go to Our Team" href="#">Our Team</a>
                    <a aria-label="Go to Careers" href="#">Careers</a>
                    <a aria-label="Go to Contact" href="#">Contact</a>
                </div>
            </div>
            <div className="footer__social-links">
                <div className="footer__social-links__link">
                ...
                <div className="footer__social-links__link">
                    <a aria-label="Go to Twitter" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                            <title>Twitter</title>
                ...
                <div className="footer__social-links__link">
                    <a aria-label="Go to Pinterest" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
